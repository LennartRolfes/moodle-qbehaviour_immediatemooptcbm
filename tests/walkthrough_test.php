...
namespace qbehaviour_immediatemooptcbm;
...
/**
 * Unit tests for the immediate cbm  for MooPT quesitons.
 *
...
class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    public function test_immediatemooptcbm_feedback_multichoice_right() {
    ...
    public function test_immediatemooptcbm_feedback_multichoice_try_to_submit_blank() {
    ...
    public function test_immediatemooptcbm_feedback_shortanswer_try_to_submit_no_certainty() {
    ...
    public function test_immediatemooptcbm_feedback_multichoice_wrong_on_finish() {
    ...
    public function test_immediatemooptcbm_cbm_truefalse_no_certainty_feedback_when_not_answered() {
